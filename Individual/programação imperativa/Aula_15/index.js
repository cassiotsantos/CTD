...
let clientes = [
  ...
  /*
   1. Objetos -> São representações do mundo real no Javascript que possuem:

      1.1. Propriedades -> Informações que descrevem o dado que estamos criando.

      1.2. Metódos -> Ações pertinentes ao objeto. ou seja, Metódo é Uma função que pertence a um objeto. Ex:  
  ...
  */
  ...
  Para manipular os dados  dentro de um objetivo, podemos usar:
  ...
  */
  ...
  console.log(cliente1.nomeMetodo()); // para usar um método, temos que fazer a chamada do método, igual fazemos com a funçào
